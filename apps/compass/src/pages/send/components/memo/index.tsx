  ...
  return (
    <div
      className={classNames(
        'p-5 rounded-xl bg-secondary-100 border border-secondary flex justify-between items-center dark:focus-within:border-white-100 hover:border-secondary-400 focus-within:border-black-100 w-full',
        containerClassname,
      )}
    >
      <input
