          ...
          {saveAsCEX && (
            <div
              className={classNames(
                'p-5 rounded-xl bg-secondary-50 border border-secondary flex justify-between items-center dark:focus-within:border-white-100 hover:border-secondary-400 focus-within:border-black-100 w-full px-4 py-3',
              )}
            >
              <input
                type='text'
