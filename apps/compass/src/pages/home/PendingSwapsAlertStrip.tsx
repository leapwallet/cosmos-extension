...
const PendingSwapsAlertStrip = () => {
  ...
  return (
    <>
      <div
        className={classNames(
          'sticky bottom-[74px] px-4 py-3 w-full flex flex-row justify-between gap-3 items-center rounded-t-2xl shadow-[inset_0px_-4px_11.199999809265137px_0px_#00000040]',
          {
