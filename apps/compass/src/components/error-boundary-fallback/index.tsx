...
const ErrorBoundaryFallback = () => {
  ...
  return (
    <div className='relative w-full overflow-clip enclosing-panel panel-height'>
      <PopupLayout header={<Header title={'Compass Wallet'} />} skipWatchingWalletHeader>
        <div
          className='flex flex-col items-center justify-center w-full'
          style={{
            height: 'calc(100% - 72px)',
            background: Colors.compassGradient,
          }}
        >
          <div className='flex justify-center space-x-2'>
            <img src={Images.Logos.CompassCircle} height='150px' />
