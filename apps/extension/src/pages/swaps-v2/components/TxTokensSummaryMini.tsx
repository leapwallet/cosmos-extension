...
function TxTokensSummaryMini({ inAmount, sourceToken, amountOut, destinationToken }: Props) {
  ...
  return (
    <div className='w-full bg-white-100 dark:bg-gray-950 flex items-center justify-between p-4 gap-2 rounded-2xl'>
      <div className='flex justify-center gap-1 items-center w-full max-w-[140px]'>
        <img
        ...
        />
        <div className='text-black-100 text-center whitespace-nowrap overflow-hidden max-w-full text-ellipsis font-bold text-sm !leading-[19.6px] dark:text-white-100'>
          {sourceBalance}
        </div>
      </div>

      <div className='bg-gray-100 dark:bg-gray-850 shrink-0 flex justify-center items-center w-[24px] h-[24px] rounded-full'>
        <span className='text-black-100 dark:text-white-100 material-icons-round !leading-[16px] text-xs'>
          arrow_forward
        </span>
      </div>

      <div className='flex justify-center gap-1 items-center max-w-[140px] w-full'>
        <img
          className='bg-gray-100 dark:bg-gray-850 h-[24px] w-[24px] rounded-full'
