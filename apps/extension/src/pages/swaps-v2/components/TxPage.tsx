  ...
  return (
    <div className='absolute w-[400px] overflow-clip top-0 z-[10]'>
      <div className='relative'>
                ...
                <div className='justify-between items-center flex flex-row gap-2'>
                  <div>
                    <div className='flex items-center justify-start gap-1 font-bold text-black-100 dark:text-white-100 text-sm !leading-[20px]'>
                      <span className='!text-md material-icons-round'>
                        {isLoading ? 'timer' : 'receipt'}
                      </span>
                      <span>{isLoading ? `~ ${timeApprox}` : 'Transaction Summary'}</span>
                    </div>
                  </div>
                  <button
                    className='w-[24px] h-[24px] justify-center items-center gap-[8px] flex flex-row !text-[24px] material-icons-round !leading-[24px] text-gray-400 dark:text-gray-600'
                    onClick={() => {
                      setIsTxStepsVisible(!isTxStepsVisible)
                    }}
                  >
                    {isTxStepsVisible ? 'keyboard_arrow_up' : 'keyboard_arrow_down'}
                  </button>
                </div>
        ...
        <div className='dark:bg-black-100 bg-gray-50 flex flex-row items-center justify-between gap-4 absolute bottom-0 left-0 right-0 p-6 z-10'>
          <button
            className={classNames(
              ...
              {
                '!leading-[24px] material-icons-round !text-lg w-[46px] shrink-0': isLoading,
