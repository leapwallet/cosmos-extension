...
import { AggregatedGovernanceNullComponents, ProposalCard } from './index'

const NETWORK = 'mainnet'

export function AggregatedGovernance() {
  ...
  return (
    <div className='relative w-[400px] overflow-clip'>
      <AggregatedGovernanceNullComponents />
