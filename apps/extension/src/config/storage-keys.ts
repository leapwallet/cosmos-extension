...
export const EARN_USDN_FEATURE_SHOW = 'earn-usdn-feature-show'
export const EARN_USDN_HIGHLIGHT_SHOW = 'earn-usdn-highlight-show'
export const EARN_USDN_BANNER_SHOW = 'earn-usdn-banner-show'
export const READ_ITEMS_ALPHA_OPPORTUNITIES = 'read-items-alpha-opportunities'
export const LEAP_CHADS_HIGHLIGHT_SHOW = 'leap-chads-highlight-show'
...
export const BOOKMARKED_CHAD_LISTINGS = 'bookmarked-chad-listings'
export const LEAP_CHAD_FIRST_VISIT = 'leap-chad-first-visit'
export const VIEWED_RAFFLE_WINS = 'viewed-raffle-wins'
export const GAS_ESTIMATE_CACHE = 'gas-estimate-cache'
