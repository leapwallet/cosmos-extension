import { fromSmall, NativeDenom } from '@leapwallet/cosmos-wallet-sdk';
 ...
 */
export const useShouldShowAutoAdjustSheet = (): ((args: shouldShowAutoAdjustArgs) => AdjustmentType) => {
  const nativeDenom = useNativeFeeDenom();
