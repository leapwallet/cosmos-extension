...
export class Snip20Querier extends ComputeQuerier {
  getSnip20Params = async ({ contract }: { contract: SecretContract }): Promise<GetTokenParamsResponse> => {
    return await this.queryContract<GetTokenParamsRequest, GetTokenParamsResponse>({
  ...
  getBalance = async ({
    ...
    if (auth.key) {
      ...
      return await this.queryContract<GetBalanceRequestWithPermit, GetBalanceResponse>({
        contract_address: contract.address,
        code_hash: contract.code_hash,
        query: {
          with_permit: {
  ...
  getTransferHistory = async ({
    ...
    if (auth.key) {
      return await this.queryContract<GetTransferHistoryRequest, TransferHistoryResponse>({
        contract_address: contract.address,
        code_hash: contract.code_hash,
        query: {
          transfer_history: {
      ...
      return await this.queryContract<GetTransferHistoryRequestWithPermit, TransferHistoryResponse>({
        contract_address: contract.address,
        code_hash: contract.code_hash,
        query: {
          with_permit: {
  ...
  getTransactionHistory = async ({
    ...
    if (auth.key) {
      return await this.queryContract<GetTransactionHistoryRequest, TransactionHistoryResponse>({
        contract_address: contract.address,
        code_hash: contract.code_hash,
        query: {
          transaction_history: {
      ...
      return await this.queryContract<GetTransactionHistoryRequestWithPermit, TransactionHistoryResponse>({
        contract_address: contract.address,
        code_hash: contract.code_hash,
        query: {
          with_permit: {
  ...
  GetAllowance = async ({
    ...
    if (auth.key) {
      return await this.queryContract<GetAllowanceRequest, GetAllowanceResponse>({
        contract_address: contract.address,
        code_hash: contract.code_hash,
        query: {
          allowance: {
      ...
      return await this.queryContract<GetAllowanceRequestWithPermit, GetAllowanceResponse>({
        contract_address: contract.address,
        code_hash: contract.code_hash,
        query: {
          with_permit: {
