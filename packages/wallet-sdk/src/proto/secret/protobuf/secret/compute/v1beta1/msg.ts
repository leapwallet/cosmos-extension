  ...
  toJSON(message: MsgStoreCode): unknown {
    ...
    message.wasm_byte_code !== undefined &&
      (obj.wasm_byte_code = base64FromBytes(
        message.wasm_byte_code !== undefined ? message.wasm_byte_code : new Uint8Array(),
      ));
...
export const MsgInstantiateContract = {
  ...
  fromJSON(object: any): MsgInstantiateContract {
    return {
      sender: isSet(object.sender) ? bytesFromBase64(object.sender) : new Uint8Array(),
      callback_code_hash: isSet(object.callback_code_hash) ? String(object.callback_code_hash) : '',
      code_id: isSet(object.code_id) ? String(object.code_id) : '0',
      label: isSet(object.label) ? String(object.label) : '',
      init_msg: isSet(object.init_msg) ? bytesFromBase64(object.init_msg) : new Uint8Array(),
      init_funds: Array.isArray(object?.init_funds) ? object.init_funds.map((e: any) => Coin.fromJSON(e)) : [],
      callback_sig: isSet(object.callback_sig) ? bytesFromBase64(object.callback_sig) : new Uint8Array(),
  ...
  toJSON(message: MsgInstantiateContract): unknown {
    ...
    message.sender !== undefined &&
      (obj.sender = base64FromBytes(message.sender !== undefined ? message.sender : new Uint8Array()));
    message.callback_code_hash !== undefined && (obj.callback_code_hash = message.callback_code_hash);
    message.code_id !== undefined && (obj.code_id = message.code_id);
    ...
    if (message.init_funds) {
      obj.init_funds = message.init_funds.map((e) => (e ? Coin.toJSON(e) : undefined));
    } else {
      obj.init_funds = [];
    }
    message.callback_sig !== undefined &&
      (obj.callback_sig = base64FromBytes(
        message.callback_sig !== undefined ? message.callback_sig : new Uint8Array(),
      ));
...
export const MsgExecuteContract = {
  ...
  fromJSON(object: any): MsgExecuteContract {
    return {
      ...
      callback_code_hash: isSet(object.callback_code_hash) ? String(object.callback_code_hash) : '',
      sent_funds: Array.isArray(object?.sent_funds) ? object.sent_funds.map((e: any) => Coin.fromJSON(e)) : [],
      callback_sig: isSet(object.callback_sig) ? bytesFromBase64(object.callback_sig) : new Uint8Array(),
    };
  },
  ...
  toJSON(message: MsgExecuteContract): unknown {
    ...
    if (message.sent_funds) {
      obj.sent_funds = message.sent_funds.map((e) => (e ? Coin.toJSON(e) : undefined));
    } else {
      obj.sent_funds = [];
    }
    message.callback_sig !== undefined &&
