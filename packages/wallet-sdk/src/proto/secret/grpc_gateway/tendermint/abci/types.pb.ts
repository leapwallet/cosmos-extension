...
export class ABCIApplication {
  ...
  static SetOption(req: RequestSetOption, initReq?: fm.InitReq): Promise<ResponseSetOption> {
    return fm.fetchReq<RequestSetOption, ResponseSetOption>(`/tendermint.abci.ABCIApplication/SetOption`, {
      ...initReq,
      method: 'POST',
      body: JSON.stringify(req, fm.replacer),
    });
  ...
  static DeliverTx(req: RequestDeliverTx, initReq?: fm.InitReq): Promise<ResponseDeliverTx> {
    return fm.fetchReq<RequestDeliverTx, ResponseDeliverTx>(`/tendermint.abci.ABCIApplication/DeliverTx`, {
      ...initReq,
      method: 'POST',
      body: JSON.stringify(req, fm.replacer),
    });
  ...
  static BeginBlock(req: RequestBeginBlock, initReq?: fm.InitReq): Promise<ResponseBeginBlock> {
    return fm.fetchReq<RequestBeginBlock, ResponseBeginBlock>(`/tendermint.abci.ABCIApplication/BeginBlock`, {
      ...initReq,
      method: 'POST',
      body: JSON.stringify(req, fm.replacer),
    });
  ...
  static EndBlock(req: RequestEndBlock, initReq?: fm.InitReq): Promise<ResponseEndBlock> {
    return fm.fetchReq<RequestEndBlock, ResponseEndBlock>(`/tendermint.abci.ABCIApplication/EndBlock`, {
      ...initReq,
      method: 'POST',
      body: JSON.stringify(req, fm.replacer),
    });
  ...
  static LoadSnapshotChunk(req: RequestLoadSnapshotChunk, initReq?: fm.InitReq): Promise<ResponseLoadSnapshotChunk> {
    return fm.fetchReq<RequestLoadSnapshotChunk, ResponseLoadSnapshotChunk>(
  ...
  static ApplySnapshotChunk(req: RequestApplySnapshotChunk, initReq?: fm.InitReq): Promise<ResponseApplySnapshotChunk> {
    return fm.fetchReq<RequestApplySnapshotChunk, ResponseApplySnapshotChunk>(
