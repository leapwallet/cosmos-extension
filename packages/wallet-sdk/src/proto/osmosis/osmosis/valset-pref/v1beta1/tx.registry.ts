...
export const registry: ReadonlyArray<[string, GeneratedType]> = [
  ['/osmosis.valsetpref.v1beta1.MsgSetValidatorSetPreference', MsgSetValidatorSetPreference],
  ['/osmosis.valsetpref.v1beta1.MsgDelegateToValidatorSet', MsgDelegateToValidatorSet],
  ['/osmosis.valsetpref.v1beta1.MsgUndelegateFromValidatorSet', MsgUndelegateFromValidatorSet],
  ['/osmosis.valsetpref.v1beta1.MsgRedelegateValidatorSet', MsgRedelegateValidatorSet],
  ['/osmosis.valsetpref.v1beta1.MsgWithdrawDelegationRewards', MsgWithdrawDelegationRewards],
  ['/osmosis.valsetpref.v1beta1.MsgDelegateBondedTokens', MsgDelegateBondedTokens],
];
