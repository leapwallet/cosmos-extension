...
export const registry: ReadonlyArray<[string, GeneratedType]> = [
  ...
  ['/osmosis.concentratedliquidity.v1beta1.MsgCollectSpreadRewards', MsgCollectSpreadRewards],
  ['/osmosis.concentratedliquidity.v1beta1.MsgCollectIncentives', MsgCollectIncentives],
];
