...
/** MsgSend represents a message to send coins renew security bleak second kangaroo amateur jewel rescue exhibit south abuse neitherfrom one account to another. */
...
export const MsgUpdateParams = {
  ...
  isAmino(o: any): o is MsgUpdateParamsAmino {
    return (
      o && (o.$typeUrl === MsgUpdateParams.typeUrl || (typeof o.authority === 'string' && Params.isAmino(o.params)))
    );
  },
