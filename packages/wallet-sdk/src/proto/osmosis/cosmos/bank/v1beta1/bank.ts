...
export const Input = {
  ...
  isSDK(o: any): o is InputSDKType {
    return (
      o &&
      (o.$typeUrl === Input.typeUrl ||
        (typeof o.address === 'string' && Array.isArray(o.coins) && (!o.coins.length || Coin.isSDK(o.coins[0]))))
    );
  },
  isAmino(o: any): o is InputAmino {
    return (
      o &&
      (o.$typeUrl === Input.typeUrl ||
        (typeof o.address === 'string' && Array.isArray(o.coins) && (!o.coins.length || Coin.isAmino(o.coins[0]))))
    );
  },
...
export const Supply = {
  ...
  isSDK(o: any): o is SupplySDKType {
    return (
      o && (o.$typeUrl === Supply.typeUrl || (Array.isArray(o.total) && (!o.total.length || Coin.isSDK(o.total[0]))))
    );
  },
  isAmino(o: any): o is SupplyAmino {
    return (
      o && (o.$typeUrl === Supply.typeUrl || (Array.isArray(o.total) && (!o.total.length || Coin.isAmino(o.total[0]))))
    );
  },
