...
export const BlockParams = {
  ...
  fromPartial(object: Partial<BlockParams>): BlockParams {
    const message = createBaseBlockParams();
    message.maxBytes =
      object.maxBytes !== undefined && object.maxBytes !== null ? BigInt(object.maxBytes.toString()) : BigInt(0);
    message.maxGas =
      object.maxGas !== undefined && object.maxGas !== null ? BigInt(object.maxGas.toString()) : BigInt(0);
    return message;
  },
...
export const ABCIParams = {
  ...
  toAmino(message: ABCIParams): ABCIParamsAmino {
    ...
    obj.vote_extensions_enable_height =
      message.voteExtensionsEnableHeight !== BigInt(0) ? (message.voteExtensionsEnableHeight?.toString)() : undefined;
    return obj;
  },
