    ...
    case 'cosmos-sdk/GenericAuthorization':
      return Any.fromPartial({
        ...
        value: GenericAuthorization.encode(
          GenericAuthorization.fromPartial(GenericAuthorization.fromAmino(content.value)),
        ).finish(),
      });
    case 'cosmos-sdk/SendAuthorization':
      return Any.fromPartial({
        ...
        value: SendAuthorization.encode(
          SendAuthorization.fromPartial(SendAuthorization.fromAmino(content.value)),
        ).finish(),
      });
    case 'cosmos-sdk/StakeAuthorization':
      return Any.fromPartial({
        ...
        value: StakeAuthorization.encode(
          StakeAuthorization.fromPartial(StakeAuthorization.fromAmino(content.value)),
        ).finish(),
      });
    case 'wasm/StoreCodeAuthorization':
      return Any.fromPartial({
        ...
        value: StoreCodeAuthorization.encode(
          StoreCodeAuthorization.fromPartial(StoreCodeAuthorization.fromAmino(content.value)),
        ).finish(),
      });
    case 'wasm/ContractExecutionAuthorization':
      return Any.fromPartial({
        ...
        value: ContractExecutionAuthorization.encode(
          ContractExecutionAuthorization.fromPartial(ContractExecutionAuthorization.fromAmino(content.value)),
        ).finish(),
      });
    case 'wasm/ContractMigrationAuthorization':
      return Any.fromPartial({
        ...
        value: ContractMigrationAuthorization.encode(
          ContractMigrationAuthorization.fromPartial(ContractMigrationAuthorization.fromAmino(content.value)),
        ).finish(),
      });
    case 'cosmos-sdk/TransferAuthorization':
      return Any.fromPartial({
        ...
        value: TransferAuthorization.encode(
          TransferAuthorization.fromPartial(TransferAuthorization.fromAmino(content.value)),
        ).finish(),
      });
    default:
