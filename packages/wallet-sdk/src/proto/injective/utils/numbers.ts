import { BigNumber, BigNumberInBase } from '../utils';
...
const getSignificantDecimalsFromNumber = (number: BigNumber | number | string): number => {
...
const getExactDecimalsFromNumber = (number: number | string): number => {
...
export const formatNumberToAllowableTensMultiplier = (
  ...
  return new BigNumberInBase(valueToBn.div(tensMul).toFixed(0, roundingMode)).multipliedBy(tensMul).toFixed(0);
};

export const formatAmountToAllowableAmount = (value: string | number, tensMultiplier: number): string => {
...
export const formatPriceToAllowablePrice = (value: string | number, tensMultiplier: number): string => {
  return tensMultiplier <= 0
 ...
 * @returns
 */
export const formatAmountToAllowableDecimals = (value: string | number, allowableDecimals: number): string => {
 ...
 * @returns
 */
export const formatPriceToAllowableDecimals = (value: string | number, allowableDecimals: number): string => {
 ...
 */
export const denomAmountFromGrpcChainDenomAmount = (value: string | number | BigNumber) =>
 ...
 * to get a workable amount
 */
export const denomAmountToGrpcChainDenomAmount = (value: string | number | BigNumber) =>
 ...
 * to get a workable amount
 */
export const amountToCosmosSdkDecAmount = (value: string | number | BigNumber) =>
  new $BigNumber(value).multipliedBy(new $BigNumber(10).pow(18));
...
export const denomAmountToChainDenomAmountToFixed = ({
  ...
  const flooredValue = tensMultiplier ? formatPriceToAllowablePrice(valueToBn, tensMultiplier) : value;
 ...
 * where x is a human readable number
 */
export const derivativeQuantityToChainQuantity = ({ value }: { value: number | string | BigNumber }) =>
  new $BigNumber(value);
 ...
 * where x is a human readable number
 */
export const derivativeQuantityFromChainQuantity = ({ value }: { value: number | string | BigNumber }) =>
  new $BigNumber(value);
...
}) => new $BigNumber(value).multipliedBy(new $BigNumber(10).pow(new $BigNumber(quoteDecimals).minus(baseDecimals)));
...
export const spotPriceFromChainPrice = ({
  ...
  quoteDecimals?: number | string;
  baseDecimals?: number | string;
}) => new $BigNumber(value).dividedBy(new $BigNumber(10).pow(new $BigNumber(quoteDecimals).minus(baseDecimals)));
...
export const cosmosSdkDecToBigNumber = (number: string | number | BigNumber): BigNumber =>
  new BigNumber(number).dividedBy(new BigNumber(10).pow(18));

export const numberToCosmosSdkDecString = (value: string | number | BigNumber): string => {
...
export { getExactDecimalsFromNumber, getSignificantDecimalsFromNumber };
