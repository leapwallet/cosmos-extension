...
import { InjectiveWasmxV1Beta1Tx } from '../../../../core-proto-ts';
...
export declare namespace MsgExecuteContractCompat {
  ...
  export type Object = Omit<InjectiveWasmxV1Beta1Tx.MsgExecuteContractCompat, 'msg'> & {
    msg: string;
  };
}
...
> {
  ...
  public toProto() {
    ...
    const message = InjectiveWasmxV1Beta1Tx.MsgExecuteContractCompat.fromPartial({});
