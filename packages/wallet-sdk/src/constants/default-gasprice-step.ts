...
export const DEFAULT_GAS_TRANSFER_SOL = 10_000;
...
export const defaultGasEstimates: Record<SupportedChain, GasEstimates> = {
  ...
  initiaEvm: DefaultGasEstimates,
  zaarEvm: DefaultGasEstimates,
  milkywayEvm: DefaultGasEstimates,
  raveEvm: DefaultGasEstimates,
  echelonEvm: DefaultGasEstimates,
  yominetEvm: DefaultGasEstimates,
  civitiaEvm: DefaultGasEstimates,
  intergazeEvm: DefaultGasEstimates,
  ingnetworkEvm: DefaultGasEstimates,
  inertiaEvm: DefaultGasEstimates,
  ...
  polygon: DefaultGasEstimates,
  base: DefaultGasEstimates,
  optimism: DefaultGasEstimates,
  blast: DefaultGasEstimates,
  manta: DefaultGasEstimates,
  lightlink: DefaultGasEstimates,
  ...
  babylon: DefaultGasEstimates,
  mainBabylon: DefaultGasEstimates,
  ...
  bob: DefaultGasEstimates,
  fluent: DefaultGasEstimates,
  soneium: DefaultGasEstimates,
