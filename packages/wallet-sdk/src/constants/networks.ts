...
export const networkData: NetworkData[] = [
  ...
  { enabled: true, name: 'intergazeEvm' },
  { enabled: true, name: 'initiaEvm' },
  { enabled: true, name: 'zaarEvm' },
  { enabled: true, name: 'raveEvm' },
  { enabled: true, name: 'inertiaEvm' },
  { enabled: true, name: 'milkywayEvm' },
  { enabled: true, name: 'ingnetworkEvm' },
  { enabled: true, name: 'yominetEvm' },
  { enabled: true, name: 'civitiaEvm' },
  { enabled: true, name: 'echelonEvm' },
